...
namespace Client.Util
{
    ...
    public class BitmapRegion
    {
        ...
        {
            int captionHeight = SystemInformation.ToolWindowCaptionHeight + 1;
            int boarderSize = SystemInformation.FixedFrameBorderSize.Width + 1;
            ...
            for (int row = 0; row < bitmap.Height; row++)
            {
                ...
                for (int col = 0; col < bitmap.Width; col++)
                {
                    ...
                    if (bitmap.GetPixel(col, row) != colorTransparent)
                    {
                        ...
                        graphicsPath.AddRectangle(new Rectangle(colOpaquePixel + boarderSize, row + captionHeight, colNext - colOpaquePixel, 1));
