...
namespace Client.Controller
{
	...
	public class TaskbarNotifier : System.Windows.Forms.Form
	{
		...
		protected Font normalTitleFont = new Font("Arial",15,FontStyle.Regular,GraphicsUnit.Pixel);
		protected Font hoverTitleFont = new Font("Arial",15,FontStyle.Bold,GraphicsUnit.Pixel);
		protected Font normalContentFont = new Font("Arial",13,FontStyle.Regular,GraphicsUnit.Pixel);
		protected Font hoverContentFont = new Font("Arial",13,FontStyle.Regular,GraphicsUnit.Pixel);
        ...
        public Client.Model.ContentClickEventHandler ContentClick = null;
		#endregion
		...
		/// </summary>
		public TaskbarNotifier(string content)
		{
        ...
        {
            string strTitle = "From monitor...";
            string strContent = this.contentText;
            int nTimeToShow = 500;
            int nTimeToStay = 300;
            int nTimeToHide = 300;            

            SetBackgroundBitmap(Resource1.skin, Color.FromArgb(255, 0, 255));            
            SetCloseBitmap(Resource1.close, Color.FromArgb(255, 0, 255));
            TitleRectangle = new Rectangle(70, 20, 150, 25);
            ContentRectangle = new Rectangle(20, 50, 207, 140);
            ...
            switch (taskbarState)
            {
                case TaskbarStates.hidden:
                    ...
                    SetBounds(WorkAreaRectangle.Right - BackgroundBitmap.Width, WorkAreaRectangle.Bottom - bh * position, BackgroundBitmap.Width, 0);
                ...
                case TaskbarStates.disappearing:
                    ...
                    SetBounds(WorkAreaRectangle.Right - BackgroundBitmap.Width, WorkAreaRectangle.Bottom - BackgroundBitmap.Height-bh*position, BackgroundBitmap.Width, BackgroundBitmap.Height);
		...
		public void SetCloseBitmap(string strFilename, Color transparencyColor)
		{
            ...
            CloseBitmapLocation = new Point(220,10);
		}
		...
		protected void DrawText(Graphics grfx)
		{
			...
			{			
				if (bIsMouseOverTitle)
					grfx.DrawString(titleText, hoverTitleFont, new SolidBrush(hoverTitleColor), TitleRectangle);
				else
					grfx.DrawString(titleText, normalTitleFont, new SolidBrush(normalTitleColor), TitleRectangle);
			}
			...
			if (contentText != null && contentText.Length != 0)
			{
                ...
                sf.Trimming = StringTrimming.Character;						// Added Rev 002                
                ...
                {
                    int len=(int)(Math.Floor(contentText.Length * (ContentRectangle.Height/sizefContent.Height)))-3;
                    content = contentText.Substring(0, len) + "....";                    
                }

				if (bIsMouseOverContent)
				{
                    grfx.DrawString(content, hoverContentFont, new SolidBrush(hoverContentColor), ContentRectangle, sf);
                    ...
                    grfx.DrawString(content, normalContentFont, new SolidBrush(normalContentColor), ContentRectangle, sf);
			}
		}
		...
		protected void CalculateMouseRectangles()
		{
			...
			{
				RealTitleRectangle = new Rectangle(TitleRectangle.Left, TitleRectangle.Top, ContentRectangle.Width, (int)sizefTitle.Height);
			}
			...
			if (sizefContent.Height > ContentRectangle.Height)
			{
				//RealContentRectangle = new Rectangle((ContentRectangle.Width-(int)sizefContent.Width)/2+ContentRectangle.Left, ContentRectangle.Top, ContentRectangle.Width, ContentRectangle.Height );
                RealContentRectangle = ContentRectangle;
			}
			else
			{
                ...
                RealContentRectangle = new Rectangle(ContentRectangle.X, ContentRectangle.Y, (int)sizefContent.Width, (int)sizefContent.Height);
			}
		...
		protected void OnTimer(Object obj, EventArgs ea)
		{
			switch (taskbarState)
			{
				...
				case TaskbarStates.disappearing:
					...
					break;
                case TaskbarStates.pushing:
                    count++;
                    if (count < 50)
                    {                        
                        SetBounds(Left, Top - nIncrementShow, Width, bh);
                    }
                    else
                    {
                        count = 0;
        ...
        public void PushNotifier()
        {
            taskbarState = TaskbarStates.pushing;
            timer.Start();
        }

        public void FallNotifier()
        {
            taskbarState = TaskbarStates.falling;
            timer.Start();
        }
		...
		protected override void OnMouseUp(MouseEventArgs mea)
		{
			...
			else if (bIsMouseOverContent)
			{
				if (ContentClick != null)
                    ContentClick(this, new Client.Model.ContentClickEventArgs(contentText));
			}
		}
